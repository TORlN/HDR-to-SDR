...
4. Compile the executable:
    ```sh
    pyinstaller --onefile --noconsole --name "HDR_to_SDR_Converter" --icon=logo/icon.ico --paths=.venv/Lib/site-packages ^
        ...
        --add-binary ".venv/Lib/site-packages/PIL;PIL" ^
        --add-binary ".venv/Lib/site-packages/numpy;numpy" ^
        src/main.py
    ```
